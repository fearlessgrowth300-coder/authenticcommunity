...
const categoryKeywords: Record<string, string[]> = {
  "outdoors": ["hiking", "nature", "travel", "cycling", "running", "camping", "outdoors"],
  "food & drink": ["food", "cooking", "coffee", "wine", "restaurant", "baking"],
  "arts & culture": ["art", "music", "film", "photography", "writing", "culture"],
  "wellness": ["wellness", "yoga", "meditation", "mental health", "fitness", "mindfulness"],
  "tech": ["tech", "coding", "software", "design", "ai", "startup", "programming"],
