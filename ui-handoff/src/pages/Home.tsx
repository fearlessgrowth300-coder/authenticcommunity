...
import { loadFeedPage, type PostFeedItem } from '../lib/feedApi'
  ...
  useEffect(() => {
    ...
    const loadHomeData = async () => {
      ...
      try {
        ...
        toast(err?.message || 'Error loading dashboard data.')
      } finally {
        setLoading(false)
      }
    }
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-5 flex gap-3">
                      ...
                      <Button
                        variant="secondary"
                        onClick={() => {
                          toast('Opening direct conversation');
...
function Guide({
  ...
  const routes: Record<string, string> = {
    ...
    'Send a message': '/messages/direct',
  ...
  useEffect(() => {
    ...
    const loadNotifs = async () => {
      ...
      if (data && data.length > 0) {
        ...
        // Fallback realistic notification seed items
        setNotifications([
          {
            id: 'n1',
            title: 'Maya Patel',
