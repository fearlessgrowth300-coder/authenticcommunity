  ...
  return (
    <div className="min-h-screen bg-background flex flex-col px-6 pt-4 max-w-lg mx-auto">
      ...
      <div className="animate-fade-in">
        ...
        <p className="text-muted-foreground mb-8">Sign in to continue connecting</p>
      </div>
      ...
      <div className="flex gap-3">
        <Button variant="outline" className="flex-1" type="button" onClick={handleGoogleLogin}>
        ...
        <Button variant="outline" className="flex-1" type="button" onClick={handleAppleLogin}>
