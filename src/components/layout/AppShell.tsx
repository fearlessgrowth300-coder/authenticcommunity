        ...
        <header className="sticky top-0 z-20 border-b border-brand-line/80 bg-white/90 backdrop-blur">
          <div className="mx-auto flex max-w-6xl items-center gap-3 px-4 py-3 sm:px-6">
            ...
            <button
              ...
              className="hidden items-center gap-2 rounded-xl border border-brand-line bg-white px-3 py-2 text-sm text-brand-muted md:flex"
            >
            ...
            <button
              ...
              className="relative grid h-10 w-10 place-items-center rounded-xl border border-brand-line bg-white"
            >
              <Bell className="h-5 w-5" />
